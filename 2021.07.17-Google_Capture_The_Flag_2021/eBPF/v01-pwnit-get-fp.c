...
static void prep(void) {
  ...
  struct bpf_insn prog[] = {
      ...
      /* if (cmd == GET_FP) goto get_fp; */
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, GET_FP, 2),
      /* if (cmd == KEEP_ALIVE) goto verifier_off; */
      BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, KEEP_ALIVE, 9),
      /* return r0; */
      BPF_EXIT_INSN(),
